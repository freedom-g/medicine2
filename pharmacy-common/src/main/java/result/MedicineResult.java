...
public class MedicineResult {
	 ...
	 * @return
	 */
	public static MedicineResult formatToPojo(String jsonData, Class<?> clazz) {
		try {
			if (clazz == null) {
				return MAPPER.readValue(jsonData, MedicineResult.class);
			}
	 ...
	 * @return
	 */
	public static MedicineResult format(String json) {
		try {
			return MAPPER.readValue(json, MedicineResult.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	 ...
	 * @return
	 */
	public static MedicineResult formatToList(String jsonData, Class<?> clazz) {
		try {
			JsonNode jsonNode = MAPPER.readTree(jsonData);
			JsonNode data = jsonNode.get("data");
			Object obj = null;
