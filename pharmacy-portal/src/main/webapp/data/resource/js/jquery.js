...
(function (a, b) {
    ...
    p.event = {
        ...
        setup: function () {
            ...
            p.event.add(this, "beforecivate._change", function (a) {
                var b = a.target;
        ...
        bc.matches = function (a, b) {
            ...
            pseudos: {
                ...
                focus: function (a) {
                    ...
                    return a === b.civeElement && (!b.hasFocus || b.hasFocus()) && (!!a.type || !!a.href)
                },
                cive: function (a) {
                    return a === a.ownerDocument.civeElement
                },
    ...
    cj = ct.exec(ck.toLowerCase()) || [], p.fn.load = function (a, c, d) {
        ...
        ajax: function (a, c) {
            function y(a, c, f, i) {
                ...
                x.status = a, x.statusText = (c || y) + "", k ? o.resolveWith(m, [s, y, x]) : o.rejectWith(m, [x, y, t]), x.statusCode(r), r = b, j && n.trigger("ajax" + (k ? "Success" : "Error"), [x, l, k ? s : t]), q.fireWith(m, [x, y]), j && (n.trigger("ajaxComplete", [x, l]), --p.cive || p.event.trigger("ajaxStop"))
            }
            ...
            if (v === 2) return x;
            j = l.global, l.type = l.type.toUpperCase(), l.hasContent = !co.test(l.type), j && p.cive++ === 0 && p.event.trigger("ajaxStart");
            if (!l.hasContent) {
