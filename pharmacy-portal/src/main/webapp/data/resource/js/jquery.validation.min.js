...
(function (t) {
    t.extend(t.fn, {
        validate: function (e) {
            ...
            return i ? i : (i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.validateDelegate(":submit", "click", function (e) {
        ...
        messages: {
            ...
            maxlength: t.validator.format("Please enter no more than {0} charcers."),
            minlength: t.validator.format("Please enter at least {0} charcers."),
            rangelength: t.validator.format("Please enter a value between {0} and {1} charcers long."),
