	...
	return $(this).each(function(){
		...
		tree	
			.focus(function(event){
				//decivate previously cive tree node, if one exists
				tree.find('[tabindex=0]').attr('tabindex','-1').removeClass('tree-item-cive');
				//assign 0 tabindex to focused item
				$(event.target).attr('tabindex','0').addClass('tree-item-cive');
			})
