...
<script async="" src="https://gw.alipayobjects.com/os/secjs/f4bd58f8-f1a1-4e2d-9e05-4ecffd2b4ab2/excashier_rds_auth.js"></script><script type="text/javascript">
...
cimg.src = "https://ynuf.alipay.com/service/clear.png?xt=Pd9afeffb8ad607e1834d5a64d1fd6cec&xa=";
</script>
...
um.init({
    ...
    token: 'Pd9afeffb8ad607e1834d5a64d1fd6cec', timestamp: '8563885359595F435941607E',
                ...
                实物订单_980635275990684447
                                            ...
                                            <span class="second short-content">
                                                ...
                                                <span class="payAmount-area" id="J_basePriceArea">
                                                     <strong class=" amount-font-22 ">28.00</strong> 元
...
<div class="ui-tip ui-question-tip fn-hide" data-role="J_exchangeTip">
            ...
            <a id="J_OrderExtTrigger" class="order-ext-trigger" href="#" seed="order-detail-more" data-role="J_oderDetailMore">
                ...
                <div class="ui-detail fn-hide" data-role="J_orderDetailCnt" id="J-orderDetail">
                    <div class="ajax-Account od-more-cnt fn-clear">
                        <div class="first  long-content">实物订单_980635275990684447</div>
    ...
    <tbody>
        ...
        <input name="oid" type="hidden" value="5e0e5102cc334a20a640c2394f6c63e3.00" id="J_orderId">
        <input name="pid" type="hidden" value="2088811263891351" id="J_partnerId">
        <input name="pid" type="hidden" value="980635275990684447" id="J_outBizID">
        <input name="qrContextId" type="hidden" value="20200217ccmc-49-00Tb6e5902216f4101" id="J_qrContextId">
    ...
    <div class="cashier-center-container">
        ...
        <div data-module="excashier/login/2019.10.11/loginPwdMemberT" id="J_loginPwdMemberTModule" class="cashiser-switch-wrapper fn-clear">
...
<div id="hidden-input-area" class="fn-hide">
    <input name="qrCode" type="hidden" value="https://qr.alipay.com/upx05842jdkyhwml0fgr0064" id="J_qrCode">
    <input name="qrImgUrl" type="hidden" value="https://mobilecodec.alipay.com/show.htm?code=upx05842jdkyhwml0fgr0064" id="J_qrImgUrl">
    <input name="qrUseImage" type="hidden" value="false" id="J_qrUseImage">
    <input name="qrContextId" type="hidden" value="20200217ccmc-49-00Tb6e5902216f4101" id="J_qrContextId">
    <input name="qrRenewalURL" type="hidden" value="https://excashier.alipay.com:443/standard/renewQRCode.json?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00" id="J_qrRenewalURL">
    <input name="qrPushCheckURL" type="hidden" value="" id="J_qrPushCheckURL">
    <input name="qrLoopCheckURL" type="hidden" value="https://excashier.alipay.com:443/standard/queryQRStatus.json?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00" id="J_qrLoopCheckURL">
    <input name="qrPaySuccGotoURL" type="hidden" value="https://unitradeprod.alipay.com:443/acq/cashierReturn.htm?sign=K1iSL1GMwtZLDOtSbItkPUmr4BUbe9m8Wm6rTkCvphwiLYfQMI7%252FZO8LWNvbz9dNTUfuEg%253D%253D&amp;outTradeNo=980635275990684447&amp;pid=2088811263891351&amp;type=1" id="J_qrPaySuccGotoURL">
...
<div data-role="qrPayArea" class="qrcode-integration qrcode-area" id="J_qrPayArea">
        ...
        <div class="ft-center qrcode-header-money">28.00</div>
    </div>
        ...
        <div style="position: relative;display: inline-block;"><canvas width="168" height="168" style="float: left;"></canvas><img src="https://t.alipayobjects.com/tfscom/T1Z5XfXdxmXXXXXXXX.png" style="position: absolute;top: 50%;left: 50%;width:42px;height:42px;margin-left: -21px;margin-top: -21px"></div></div>

        <div class="qrcode-img-explain fn-clear">
            <img class="fn-left" src="https://t.alipayobjects.com/images/T1bdtfXfdiXXXXXXXX.png" alt="扫一扫标识" seed="qrcodeImgExplain-tImagesT1bdtfXfdiXXXXXXXX" smartracker="on">
...
<div class="qrguide-area" id="J_qrguideArea" seed="NewQr_animationClick">
    <img src="https://t.alipayobjects.com/images/rmsweb/T13CpgXf8mXXXXXXXX.png" class="qrguide-area-img background" seed="J_qrguideArea-qrguideAreaImg" smartracker="on">
    <img src="https://t.alipayobjects.com/images/rmsweb/T1ASFgXdtnXXXXXXXX.png" class="qrguide-area-img active" seed="J_qrguideArea-qrguideAreaImgT1" smartracker="on" style="display: block;">
</div>
...
<div class="view-switch qrcode-show fn-left" id="J_viewSwitcher" unselectable="on" onselectstart="return false;" seed="NewQr_viewSwitch">
    ...
    <div class="switch-tip switch-qrcode-tip " id="J_tip_qr">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="https://t.alipayobjects.com/images/T1HHFgXXVeXXXXXXXX.png" alt="支付宝图标" width="50" height="17" seed="switchTipIconWrapper-switchTipIconImg" smartracker="on">
        </div>
    ...
    <div class="switch-tip switch-pc-tip fn-hide" id="J_tip_pc">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="https://t.alipayobjects.com/tfscom/T1Z5XfXdxmXXXXXXXX.png" alt="手机支付宝图标" width="30" height="30" seed="switchTipIconWrapper-switchTipIconImgT1" smartracker="on">
        </div>
        <a class="switch-tip-btn" href="javascript:void(0)" seed="J_tip_pc-switchTipBtn" smartracker="on">扫一扫付款&nbsp;&gt;</a>
            ...
            <div class="cashier-center-view view-pc fn-left" id="J_view_pc">
                <form action="https://excashier.alipay.com:443/standard/securityPost.json?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00&amp;viewModel=payerPwdLoginViewModel" method="post" id="J_TloginForm">
                    <input type="hidden" name="commonAccountIdentiAuthUrl" value="https://excashier.alipay.com:443/standard/securityRender.phtm?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00&amp;viewModel=payerPwdLoginViewModel">
                                        	<input type="hidden" name="_form_token" value="cc43ea4acb1def937cf607d5cfc4735f97913104b7f5496eae0bad380872390eRZ41">
...
<div class="loginBox">
    ...
    <div class="teForm">
        <div class="login-panel">
            ...
            <div class="mi-form-item commonAccountContainer quick-empty-parent" id="J_commonAccountContainer">
                ...
                <input type="email" name="loginId" class="mi-input mi-input-account" value="" id="J_tLoginId" seed="NewQr_tAccountInput" placeholder="手机号码/邮箱" autocomplete="off" data-explain=""><span class="quick-empty" seed="quick-empty">×</span>
            ...
            <div class="mi-form-item" id="J_passwordContainer">
                ...
                <span>
                    			            <input id="J_password" type="hidden" name="password" value="" data-explain="
                    <p>
                        请输入账户的 <span class=&quot;ft-red&quot;>支付密码</span>，不是登录密码。
                    </p>
                ">
	<input type="hidden" name="pwdSecurityId" value="web|excashier_payment_pwd_control|8c11bd35-49b5-43f7-975a-3c6e2ac5ffbdRZ41">
  ...
  <input type="password" style="display:none" seed="J_passwordContainer-iptT1" smartracker="on">
                                  

        
        <span class="standardPwdContainer" style="display:none">
      <input type="password" tabindex="" id="payPasswd_input" name="payPasswd_input" class="ui-input" oncontextmenu="return false" onpaste="return false" oncopy="return false" oncut="return false" autocomplete="off" seed="standardPwdContainer-payPasswd_input" smartracker="on">
    </span>
    <span class="alieditContainer" id="payPasswd_container"><input type="password" tabindex="" id="payPasswd_rsainput" name="payPasswd_rsainput" class="ui-input i-text" oncontextmenu="return false" onpaste="return false" oncopy="return false" oncut="return false" autocomplete="off" value=""></span>
...
<!-- FD:security-service-template:securitycore/common/script_snapshot.vm:END -->
  ...
  (function () {
    ...
    s.sid = "web|excashier_payment_pwd_control|8c11bd35-49b5-43f7-975a-3c6e2ac5ffbdRZ41";
  })();
</script>
...
<input type="hidden" id="alieditUid" name="alieditUid" value="901826ef0a294003c93b964a4315c908">
...
<script>
  light.node('#payPasswd').parent().find('[name=security_activeX_enabled]')[0].value = alipay.security.activeXEnabled;
      ...
      alipay.security.snowden.record('web|excashier_payment_pwd_control|8c11bd35-49b5-43f7-975a-3c6e2ac5ffbdRZ41', {products:'singlePassword'});
    </script>
  ...
  (function(){
    ...
    var renderArr = 'R',
        ...
        options = {
          ...
          id: 'payPasswd',
          prodType: '',
          sid: 'web|excashier_payment_pwd_control|8c11bd35-49b5-43f7-975a-3c6e2ac5ffbdRZ41'
        },
        renderOptions = {
          downloadPath: '',
          ...
          R: {
            ...
            tabindex: "",
            container: "payPasswd_container",
            ksk: '425f42bc-8089-4a6c-bfc0-fc4c010c72fe',             useSixDigitPassword: false           },
          C1: {
            id: "edit_payPasswd",
            name: "edit_payPasswd",
            hidnId: "payPasswd",
          ...
          C2: {
            ...
            useKS: true,
            ksk: '425f42bc-8089-4a6c-bfc0-fc4c010c72fe'           }
        },
        sensorOptions = {
...
7、您同意，本公司有权就本服务向您收取服务费，服务费收取时间及标准届时以支付宝网站发布的公告为准。<br>
  8、您同意，您使用本服务购结汇的限额等应符合相关法律法规及监管部门或本公司的规定。<br></b>
                    ...
                    <a href="javascript:;" class="mi-button mi-button-lorange" data-role="J_forexprodConfirmAgreement" seed="alipayAgreement-miButton" smartracker="on">
...
<!-- 页面主体 结束 -->
 ...
 <!-- FD:security-service-template:securitycore/entrance/rds.vm:START -->
  ...
  <script type="text/javascript">
    var form_tk = "wAQj1FS4yReki8H8qyHySXgfA5xtOAYG";
    var json_ua = null;
  </script>

   <script type="text/javascript" charset="utf-8" src="https://rds.alipay.com/ua_excashier_rds_auth.js?t=20200217"></script>
...
<div class="fn-hide" data-role="fishing-popup">
    ...
    <div class="anti-fishing">
	    ...
	    <p>您购买的商品为：<span class="ft-break ft-bold ft-red">实物订单_980635275990684447</span>，收款方为：<strong><font color="red">北京源通百姓平安大药房有限公司</font></strong>，请确认。</p>
	    <p>建议您付款前<a href="http://bbs.taobao.com/catalog/thread/154504-251045688.htm" target="_blank" seed="antiFishing-link" smartracker="on">先查看防骗案例</a></p>
...
<input type="hidden" name="commonAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00&amp;viewModel=standard%3AcommonAgreementViewModel.vm">
<input type="hidden" name="memoryPayAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=5e0e5102cc334a20a640c2394f6c63e3.00&amp;viewModel=standard%3AmemoryPayAgreementViewModel.vm">
...
seajs.use('excashier/front/2019.10.11/newCashierFront');
</script>
...
<div class="server" id="ServerNum">
  excashier-49-5341 &nbsp; 0b93b6bf15819321855631527ed831_0_1
</div>
<!-- FD:231:alipay/foot/copyright.vm:2604:foot/copyright.schema:支付宝copyright:END --><!-- FD:231:alipay/foot/copyright.vm:END --></div>
</div><!-- /container -->
<div id="partner"><img alt="合作机构" src="https://i.alipayobjects.com/e/201303/2R3cKfrKqS.png" seed="partner-iE2013032R3cKfrKqS" smartracker="on"></div>
...
try {
  ...
  if (!!window.addEventListener && Array.prototype.map && Math.random() < sample) {
	...
	setTimeout(function() {
	  window.httpWatch && window.httpWatch({ sample: 1, appname: 'excashier-49-5341', logServer: logServer });
	}, 1000);
  }
  })();
} catch(e) {}
...
<iframe id="iframeGo" name="iframeGo" style="display: none;"></iframe><ul data-role="emailListBox" class="email-suggest-out" style="width: 348px; position: absolute; z-index: 1; overflow: hidden; display: none; top: 386px; left: 1208px;"></ul><div class="ibox" tabindex="-1" style="z-index: 2011; position: fixed; left: 45px; top: 86.6667px;"><div class="ibox-close" title="关闭" data-role="boxClose" style="display: block;">×</div><div class="ibox-content" style="background-color: #fff; height: 100%; zoom: 1;"><div class="ibox-title" data-role="boxTitle" style="width: 620px;">支付宝购汇协议</div><div data-role="boxContent" style="width: 620px; height: auto;">
                <div data-role="J_alipayForexprodAgreement" class="alipay-agreement">
        <div class="alipay-agreement-content" style="text-align:left;overflow-y:scroll;border:1px #E1E1E1 solid" smartracker="on">
